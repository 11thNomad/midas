...
def test_build_feature_context_emits_snapshot_and_regime_signals():
    ...
    chain = pd.DataFrame(
        {
            "timestamp": [pd.Timestamp("2026-02-10")] * 4,
            "underlying_price": [22000.0] * 4,
            "expiry": [pd.Timestamp("2026-02-26")] * 4,
            "symbol": ["CE1", "CE2", "PE1", "PE2"],
            "option_type": ["CE", "CE", "PE", "PE"],
            "strike": [22000, 22100, 22000, 21900],
            "iv": [18.0, 19.0, 20.0, 21.0],
            "oi": [1000, 900, 1200, 800],
        }
    )
